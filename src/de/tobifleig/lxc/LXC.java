...
public class LXC {
     ...
     */
    public static final int versionId = 151;
    /**
    ...
    public LXC(Platform platform, final String[] args) {
        ...
        System.out.println("This is LanXchange v1.03 (" + versionId + ") - Copyright 2009, 2010, 2011, 2012, 2013 Tobias Fleig - License GPLv3 or later");
